...
#' The last two columns contains the angles converted to spherical coordinates with `Theta` representing the polar angle and `Phi` representing the azimuthal angle.
